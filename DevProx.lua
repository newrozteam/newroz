...
|  This Is The Source Channel @ii9_i .   |
---------------------------------------------
]]..'\27[m')
...
if text and text:match('^'..(DevAbs:get(DevProx..'Abs:NameBot') or "البوت")..' ') then
...
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔︙عذرا عزيزي ↫ ["..data.first_name_.."](t.me/ii9_i)\n⌔︙الصوره التي ارسلتها تم منعها من المجموعه", 1, 'md')
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
Dev_Abs(msg.chat_id_,0, 1, "⌔︙عذرا عزيزي ↫ ["..data.first_name_.."](t.me/ii9_i)\n⌔︙الملصق الذي ارسلته تم منعه من المجموعه", 1, 'md')
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
return false   
...
⌔︙نقاطي • بيع نقاطي
┉••┉••┉••┉••┉••┉••┉••┉┉••┉
⌔︙[Source Channel](https://t.me/ii9_i)
]], 1, 'md')
else
...
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/ii9_i' end
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔︙Channel ↬ @ii9_i', 1, 'html')    
end 
